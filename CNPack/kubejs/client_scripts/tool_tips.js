const tooltips = [
  ...
  },
  {
    ...
    text: Text.translate("tooltip.minecraft.soul_lantern").aqua(),
  },
  {
  ...
  },
  {
    ...
    text: Text.translate("tooltip.oritech.plastic_sheet").green(),
  },
  {
    item: "ftbstuff:stone_cobblestone_generator",
    text: Text.translate("tooltip.pneumaticcraft.ingot_iron_compressed").gold().append(Text.translate(`tooltip.cobblestone_generator.persec.cobble`).gray()),
  },
  {
  ...
  },
  {
    ...
    text: Text.translate("tooltip.ftbstuff.netherite_cobblestone_generator.1").gray(),
  },
  {
    item: "justdirethings:time_crystal_budding_block",
    text: Text.translate("tooltip.justdirethings.time_crystal_budding_block"),
  },
  {
    item: "justdirethings:time_crystal_budding_block",
...
ItemEvents.modifyTooltips((event) => {
  sluices.forEach((sluice) => {
    ...
    event.add(
      sluice.itemID,
      { shift: true },
      Text.translate("ooltip.sluice.fluid.usage.multiplier")
        .gray()
